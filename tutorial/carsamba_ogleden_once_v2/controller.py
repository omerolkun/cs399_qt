...
class ModiWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        #dd variables
        self.lat1_dd_tab3.setText(str(round(random.uniform(0,90))))
        self.lat2_dd_tab3.setText(str(round(random.uniform(0,90))))
        self.lon1_dd_tab3.setText(str(round(random.uniform(0,180))))
        self.lon2_dd_tab3.setText(str(round(random.uniform(0,180))))
